...
export class ShapeFactoryProducer {
    static getFactory(shapeType: ShapeType, ctx: CanvasRenderingContext2D, properties: ShapeProperties, startShape?: EndpointShape, endShape?: EndpointShape): ShapeFactory {
      switch (shapeType) {
        case ShapeType.Line:
